        ...
        <Container fixed={isDesktop}>
          <div className={classes.headerContent}>
            ...
            <nav className={cx(classes.navMenu, classes.navAuth)}>
              {!isTablet && (
                <Fragment>
                  <Button component={Link} href={routeLink.crypto.login}>
                    {t('crypto-landing.header_login')}
                  </Button>
                  <Button component={Link} href={routeLink.crypto.register} variant="contained" color="secondary" className={classes.button}>
